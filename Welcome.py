...
st.write('The predicted rock types are simultaneously plotted on the TAS diagram. The TAS plot dynamically updates based on the selected case and uploaded data.')
