...
st.subheader('Data Upload:', divider=True)
...
st.subheader('Automatic Column Verification:', divider=True)
...
st.subheader('Predicted Rock Type:', divider=True)
...
st.subheader('TAS Plot Visualization:', divider=True)
