...
st.subheader('Step 1: Upload real-world data')
st.write('You can upload real-world geochemical data in CSV format')
st.subheader('Step 2: How fake data is generated')
...
st.subheader('Step 3: View correlation matrices and download fake data')
